...
<article id="post-<?php the_ID(); ?>" <?php post_class($james_postclass); ?>>
	...
	<?php 
		if ( is_single() ) { ?>
			<div class="post-thumbnail"><?php echo do_shortcode(get_post_meta( $post->ID, '_james_meta_value_key', true )); ?></div>
		<?php }
	?>
	<?php if ( !is_single() ) { ?>
		<?php if ( has_post_thumbnail() ) { ?>
		<div class="post-thumbnail">
			<?php echo do_shortcode(get_post_meta( $post->ID, '_james_meta_value_key', true )); ?>
		</div>
		<?php } ?>
	<?php } ?>
	<?php endif; ?>
