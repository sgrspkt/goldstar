...
function james_blog_sharing() {
	...
	<div class="widget widget_socialsharing_widget">
		<h3 class="widget-title"><?php if(isset($james_opt['blog_share_title'])) { echo esc_html($james_opt['blog_share_title']); } else { esc_html_e('Share this post', 'james'); } ?></h3>
