<?php
function james_product_sharing() {
	global $james_opt;
	...
	<div class="widget widget_socialsharing_widget">
		<h3 class="widget-title"><?php if(isset($james_opt['product_share_title'])) { echo esc_html($james_opt['product_share_title']); } else { esc_html_e('Share this product', 'james'); } ?></h3>
