...
<div class="main-container full-width">
	<div class="entry-header">
		<div class="container">
			<h1 class="entry-title"><?php esc_html_e('Portfolio', 'james');?></h1>
		</div>
	</div>
	<div class="container">
		...
		<div class="page-content">
			...
			if( isset($james_opt['portfolio_per_page']) ) {
				$projects_per_page = $james_opt['portfolio_per_page'];
			}
			...
			<?php if ( $projects_query->have_posts() ) : ?>
				...
				<div class="filter-options btn-group">
					<button data-group="all" class="btn active btn--warning"><?php esc_html_e('All', 'james');?></button>
					<?php 
					$datagroups = array();
