...
<div class="mini_cart_content">
	<div class="mini_cart_inner">
		...
		<?php if ( sizeof( WC()->cart->get_cart() ) > 0 ) : ?>
			...
			<p class="buttons">
				<a href="<?php echo WC()->cart->get_cart_url(); ?>" class="button wc-forward"><?php esc_html_e( 'View Cart', 'james' ); ?></a>
				<a href="<?php echo WC()->cart->get_checkout_url(); ?>" class="button checkout wc-forward"><?php esc_html_e( 'Checkout', 'james' ); ?></a>
			</p>
